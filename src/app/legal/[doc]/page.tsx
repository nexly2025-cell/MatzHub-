...
const DOCS: Record<string, { title: string; desc: string; body: Array<[string, string]> }> = {
  ...
  shipping: {
    ...
    body: [
      ...
      ["Refunds", "Where a replacement is not possible, the team confirms the applicable refund process with you within five working days."],
  ...
  returns: {
    ...
    body: [
      ...
      ["Refunds", "Where a replacement is not possible, we refund in full. The team confirms the applicable refund process within five working days of the item being collected."],
