...
const DOCS: Record<string, { title: string; desc: string; body: Array<[string, string]> }> = {
  ...
  shipping: {
    ...
    body: [
      ...
      ["Refunds", "Where a replacement is not possible we refund to the original payment method within five working days, or by UPI transfer for cash-on-delivery orders."],
  ...
  returns: {
    ...
    body: [
      ...
      ["Refunds", "Where a replacement is not possible, we refund in full. Prepaid orders are refunded to the original payment method within five working days. Cash-on-delivery orders are refunded by UPI transfer within five working days of the item being collected."],
